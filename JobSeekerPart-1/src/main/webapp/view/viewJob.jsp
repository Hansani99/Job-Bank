...
<div class="offer">
    <div class="container">
        <div class="alert alert-secondary" role="alert" style="font-size:20px">
            <h5 class="alert-heading text-center">${jobVacancy.title}</h5>
            <p>${jobVacancy.description}</p>
            <hr>
            <h5 class="alert-heading">Company Name</h5>
            <p class="mb-0">${jobVacancy.companyName}</p>
            <hr>
            <h5 class="alert-heading">Job Industry</h5>
            <p class="mb-0">${jobVacancy.industry.name}</p>
            <hr>
            <h5 class="alert-heading">Job Type</h5>
            <p class="mb-0">${jobVacancy.jobType.name}</p>
            <hr>
            <h5 class="alert-heading">Experience Level</h5>
            <p class="mb-0">${jobVacancy.experianceLevel.name}</p>
            <hr>
            <h5 class="alert-heading">Posted Date</h5>
            <p class="mb-0">${jobVacancy.datePosted}</p>
            <hr>
        </div>
